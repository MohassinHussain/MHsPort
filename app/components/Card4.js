      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        {projects.map((project, index) => (
          <div
            ...
            className="bg-[#24283b] p-4 sm:p-6 rounded-lg border border-[#24283b] hover:border-[#7aa2f7] transition-all duration-300 transform hover:scale-105 opacity-0 translate-y-10 transition-all duration-700 ease-out"
          >
